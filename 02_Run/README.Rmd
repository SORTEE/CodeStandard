...
1. Clone this repository. For those not familiar with GitHub, click on the green button `<> Code` on the [project main page](https://github.com/SORTEE/CodeStandard) on GitHub and then on `Download ZIP` to download the entire repository, thus unzip it
