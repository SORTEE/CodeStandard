...
glm1 <- lme4::glmer(survival ~ (MismTreat1 + MismTreat2) * PhotoTreat + (1 | MotherID), family=binomial, data=d_surv,
...
glm_fit <- lme4::glmer(survival ~ MismTreat1 + MismTreat2 + (1 | MotherID), family="binomial", data=d_surv)
